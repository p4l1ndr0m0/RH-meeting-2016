...
class pr13ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/pregunta13.php")!)
        ...
        let task = NSURLSession.sharedSession().dataTaskWithRequest(request){
            ...
            NSUserDefaults.standardUserDefaults().setObject(t2, forKey:"preg45")
            NSUserDefaults.standardUserDefaults().setObject(m2, forKey:"preg46")
            NSUserDefaults.standardUserDefaults().setObject(m3, forKey:"preg47")
            NSUserDefaults.standardUserDefaults().setObject(m4, forKey:"preg48")
            NSUserDefaults.standardUserDefaults().synchronize()
            //self.dismissViewControllerAnimated(true, completion: nil)
            let pr1 = NSUserDefaults.standardUserDefaults().stringForKey("preg45") as String!
            self.self.pregunta.text = pr1
            let resp_1 = NSUserDefaults.standardUserDefaults().stringForKey("preg46") as String!
            //respA.setTitle(resp1, forState: UIControlState.Normal)
            let resp_2 = NSUserDefaults.standardUserDefaults().stringForKey("preg47") as String!
            //self.self.respB.text = resp_2
            
            let resp_3 = NSUserDefaults.standardUserDefaults().stringForKey("preg48") as String!

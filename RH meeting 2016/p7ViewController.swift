...
class p7ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        UIImage(named: "7_FondoCompletoInput.png")!.drawInRect(self.view.bounds)
    ...
    @IBAction func enviarResp(sender: AnyObject) {
        ...
        if (codigo.text == code_final){
            ...
            NSUserDefaults.standardUserDefaults().setInteger(r1, forKey:"respuesta7")
            ...
            let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/respuestas7.php")!)

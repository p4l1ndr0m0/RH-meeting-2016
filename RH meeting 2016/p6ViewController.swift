...
class p6ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        UIImage(named: "6_FondoCompletoInput.png")!.drawInRect(self.view.bounds)
    ...
    @IBAction func enviarResp(sender: AnyObject) {
        ...
        if (codigo.text == code_final){
            ...
            NSUserDefaults.standardUserDefaults().setInteger(r1, forKey:"respuesta6")
            ...
            let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/respuestas6.php")!)

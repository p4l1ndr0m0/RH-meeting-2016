...
class p5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        UIImage(named: "5_FondoCompletoInput.png")!.drawInRect(self.view.bounds)
    ...
    @IBAction func enviarResp(sender: AnyObject) {
        ...
        if (codigo.text == code_final){
            ...
            NSUserDefaults.standardUserDefaults().setInteger(r1, forKey:"respuesta5")

...
class p13ViewCOntroller: UIViewController {
    
    
    var code_final: String! = "9228"
    ...
    override func viewDidLoad() {
        ...
        UIImage(named: "13_FondoCompletoInput.png")!.drawInRect(self.view.bounds)
    ...
    @IBAction func enviarResp(sender: AnyObject) {
        ...
        if (codigo.text == code_final){
            ...
            NSUserDefaults.standardUserDefaults().setInteger(r1, forKey:"respuesta13")
            ...
            let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/respuestas13.php")!)

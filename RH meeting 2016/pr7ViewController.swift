...
class pr7ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/pregunta7.php")!)
        ...
        let task = NSURLSession.sharedSession().dataTaskWithRequest(request){
            ...
            NSUserDefaults.standardUserDefaults().setObject(t2, forKey:"preg21")
            NSUserDefaults.standardUserDefaults().setObject(m2, forKey:"preg22")
            NSUserDefaults.standardUserDefaults().setObject(m3, forKey:"preg23")
            NSUserDefaults.standardUserDefaults().setObject(m4, forKey:"preg24")
            NSUserDefaults.standardUserDefaults().synchronize()
            //self.dismissViewControllerAnimated(true, completion: nil)
            let pr1 = NSUserDefaults.standardUserDefaults().stringForKey("preg21") as String!
            self.self.pregunta.text = pr1
            let resp_1 = NSUserDefaults.standardUserDefaults().stringForKey("preg22") as String!
            //respA.setTitle(resp1, forState: UIControlState.Normal)
            let resp_2 = NSUserDefaults.standardUserDefaults().stringForKey("preg23") as String!
            //self.self.respB.text = resp_2
            
            let resp_3 = NSUserDefaults.standardUserDefaults().stringForKey("preg24") as String!

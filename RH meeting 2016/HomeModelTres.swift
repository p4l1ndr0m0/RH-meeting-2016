...
protocol HomeModelTresProtocal: class {
    func itemsDownloaded(items: NSArray)
}


class HomeModelTres: NSObject, NSURLSessionDataDelegate {
    
    //properties
    
    weak var delegate: HomeModelTresProtocal!
    
    var data : NSMutableData = NSMutableData()
    
    let urlPath: String = "http://app-pepsico.palindromo.com.mx/APP/d3.php" //Path de PHP

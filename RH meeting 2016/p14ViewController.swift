...
class p14ViewController: UIViewController {
    
    var code_final: String! = "7354"
    ...
    override func viewDidLoad() {
        ...
        UIImage(named: "14_FondoCompletoInput.png")!.drawInRect(self.view.bounds)
    ...
    @IBAction func enviarResp(sender: AnyObject) {
        ...
        if (codigo.text == code_final){
            ...
            NSUserDefaults.standardUserDefaults().setInteger(r1, forKey:"respuesta14")
            ...
            let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/respuestas14.php")!)

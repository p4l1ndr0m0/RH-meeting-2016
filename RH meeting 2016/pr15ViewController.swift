...
class pr15ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/pregunta15.php")!)
        ...
        let task = NSURLSession.sharedSession().dataTaskWithRequest(request){
            ...
            NSUserDefaults.standardUserDefaults().setObject(t2, forKey:"preg53")
            NSUserDefaults.standardUserDefaults().setObject(m2, forKey:"preg54")
            NSUserDefaults.standardUserDefaults().setObject(m3, forKey:"preg55")
            NSUserDefaults.standardUserDefaults().setObject(m4, forKey:"preg56")
            NSUserDefaults.standardUserDefaults().synchronize()
            //self.dismissViewControllerAnimated(true, completion: nil)
            let pr1 = NSUserDefaults.standardUserDefaults().stringForKey("preg53") as String!
            self.self.pregunta.text = pr1
            let resp_1 = NSUserDefaults.standardUserDefaults().stringForKey("preg54") as String!
            //respA.setTitle(resp1, forState: UIControlState.Normal)
            let resp_2 = NSUserDefaults.standardUserDefaults().stringForKey("preg55") as String!
            //self.self.respB.text = resp_2
            
            let resp_3 = NSUserDefaults.standardUserDefaults().stringForKey("preg56") as String!

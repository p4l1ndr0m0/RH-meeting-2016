...
class pr10ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/pregunta10.php")!)
        ...
        let task = NSURLSession.sharedSession().dataTaskWithRequest(request){
            ...
            NSUserDefaults.standardUserDefaults().setObject(t2, forKey:"preg33")
            NSUserDefaults.standardUserDefaults().setObject(m2, forKey:"preg34")
            NSUserDefaults.standardUserDefaults().setObject(m3, forKey:"preg35")
            NSUserDefaults.standardUserDefaults().setObject(m4, forKey:"preg36")
            NSUserDefaults.standardUserDefaults().synchronize()
            //self.dismissViewControllerAnimated(true, completion: nil)
            let pr1 = NSUserDefaults.standardUserDefaults().stringForKey("preg33") as String!
            self.self.pregunta.text = pr1
            let resp_1 = NSUserDefaults.standardUserDefaults().stringForKey("preg34") as String!
            //respA.setTitle(resp1, forState: UIControlState.Normal)
            let resp_2 = NSUserDefaults.standardUserDefaults().stringForKey("preg35") as String!
            //self.self.respB.text = resp_2
            
            let resp_3 = NSUserDefaults.standardUserDefaults().stringForKey("preg36") as String!

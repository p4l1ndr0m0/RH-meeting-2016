...
class pr5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/pregunta5.php")!)
        ...
        let task = NSURLSession.sharedSession().dataTaskWithRequest(request){
            ...
            NSUserDefaults.standardUserDefaults().setObject(t2, forKey:"preg13")
            NSUserDefaults.standardUserDefaults().setObject(m2, forKey:"preg14")
            NSUserDefaults.standardUserDefaults().setObject(m3, forKey:"preg15")
            NSUserDefaults.standardUserDefaults().setObject(m4, forKey:"preg16")
            NSUserDefaults.standardUserDefaults().synchronize()
            //self.dismissViewControllerAnimated(true, completion: nil)
            let pr1 = NSUserDefaults.standardUserDefaults().stringForKey("preg13") as String!
            self.self.pregunta.text = pr1
            let resp_1 = NSUserDefaults.standardUserDefaults().stringForKey("preg14") as String!
            let resp_2 = NSUserDefaults.standardUserDefaults().stringForKey("preg15") as String!
            let resp_3 = NSUserDefaults.standardUserDefaults().stringForKey("preg16") as String!

...
class p10ViewController: UIViewController {
    
    var code_final: String! = "7430"
    ...
    override func viewDidLoad() {
        ...
        UIImage(named: "10_FondoCompletoInput.png")!.drawInRect(self.view.bounds)
    ...
    @IBAction func enviarResp(sender: AnyObject) {
        ...
        if (codigo.text == code_final){
            ...
            NSUserDefaults.standardUserDefaults().setInteger(r1, forKey:"respuesta10")
            ...
            let request = NSMutableURLRequest(URL: NSURL(string: "http://app-pepsico.palindromo.com.mx/APP/respuestas10.php")!)
